...
const sendInterviewInvite = async ({ hrName, candidateName, candidateEmail, subject }) => {
  const mailOptions = {
      ...
      <body style="margin:0;padding:0;background:#0f0f0f;font-family:Arial,sans-serif;">
        <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
          ...
          <div style="text-align:center;margin-bottom:40px;">
            <h1 style="color:#ffffff;font-size:24px;font-weight:800;letter-spacing:-1px;margin:0;">
          ...
          <div style="background:#1a1a1a;border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:40px;">
            ...
            <p style="color:#a1a1aa;font-size:15px;line-height:1.6;margin:0 0 24px;">
              <strong style="color:#ffffff;">${hrName}</strong> from the InterviewPro talent team has reviewed your interview performance and would like to invite you for an interview opportunity.
            </p>
            ...
            <div style="background:rgba(124,58,237,0.1);border:1px solid rgba(124,58,237,0.2);border-radius:12px;padding:20px;margin-bottom:32px;">
              ...
              <p style="color:#ffffff;font-size:14px;margin:0;">
                Your mock interview scores on <strong>InterviewPro</strong> caught their attention. Keep practicing to maintain your edge!
              </p>
            </div>

            <p style="color:#a1a1aa;font-size:15px;line-height:1.6;margin:0 0 32px;">
              Log in to your InterviewPro account to view the full invite details and respond to the recruiter.
            </p>

            <!-- CTA Button -->
            <div style="text-align:center;margin-bottom:32px;">
              <a href="https://interviewpro.click/candidate/login"
                style="display:inline-block;background:#7c3aed;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:15px;letter-spacing:0.5px;">
                View Invitation →
              </a>
            </div>
            ...
            <p style="color:#52525b;font-size:12px;text-align:center;margin:0;">
              You received this email because your profile is on InterviewPro.<br/>
