...
export default function CandidateLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      gsap.to(cardRef.current, {
        ...
        onComplete: () => navigate('/candidate/subjects')
      })
    } catch (err) {
  ...
  // Animate form when toggling register/login
  const handleToggle = () => {
    ...
    <div ref={containerRef} className="min-h-screen bg-[#080808] text-white flex flex-col"
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div ref={orb2Ref}
          ...
          style={{ background: 'rgba(41,161,149,0.08)' }} />
      </div>
      ...
      <header ref={navRef}
        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto px-8 h-16">
          <div onClick={() => navigate('/')}
            className="text-lg font-black tracking-tighter text-white uppercase cursor-pointer hover:text-violet-400 transition-colors">
          ...
          <div ref={cardRef}
            ...
            <div className="text-center space-y-1.5">
              ...
              <p ref={subtitleRef} className="text-zinc-500 text-sm" style={{ opacity: 0 }}>
                {isRegister ? 'Start your interview journey today' : 'Elevate your performance. Sign in to continue.'}
              </p>
            </div>
            ...
            <button ref={googleBtnRef}
              ...
              className="w-full py-3.5 rounded-xl font-semibold text-white flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-95 group"
              style={{
                background: 'rgba(255,255,255,0.05)',
                border: '1px solid rgba(255,255,255,0.1)',
                opacity: 0
              }}
              onMouseEnter={e => gsap.to(e.currentTarget, { borderColor: 'rgba(255,255,255,0.25)', duration: 0.2 })}
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input name="name" placeholder="John Doe"
                      ...
                      onFocus={e => gsap.to(e.currentTarget, { borderColor: 'rgba(124,58,237,0.6)', duration: 0.2 })}
              ...
              {isRegister && (
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold text-zinc-400 ml-1 uppercase tracking-wider">City</label>
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-zinc-600 text-lg"
              ...
              <div className="flex justify-center">
                <ReCAPTCHA
                  ...
                  onChange={(token) => {
                    ...
                    if (token) gsap.fromTo('.g-recaptcha', { scale: 0.95 }, { scale: 1, duration: 0.3, ease: 'back.out(1.7)' })
                  }}
            ...
            <p ref={toggleRef} className="text-center text-zinc-600 text-sm" style={{ opacity: 0 }}>
              ...
              <span onClick={handleToggle}
                className="text-violet-400 hover:text-violet-300 font-bold ml-1 cursor-pointer transition-colors">
