...
export default function Landing() {
  ...
  const modalContent = {
    Privacy: {
      ...
      icon: 'shield',
      content: `At InterviewPro, we take your privacy seriously.

Data We Collect:
- Your name, email, and location when you register
- Interview session data including questions, answers, and AI scores
- Usage data to improve our platform

How We Use Your Data:
- To provide AI-powered interview evaluation
- To show your profile to HR recruiters (only if you enable "Open to Work")
...
- You can disable "Open to Work" to hide from recruiters
- Contact us to request full data deletion

Contact: support@interviewpro.click`
    },
    Terms: {
      title: 'Terms of Use',
      icon: 'gavel',
      content: `By using InterviewPro, you agree to the following terms.

Acceptable Use:
- You must be 13 years or older to use this platform
- You may not use this platform for any illegal purposes
- You may not attempt to hack, scrape, or abuse our systems
- One account per person is allowed

Interview Content:
- AI evaluations are for practice purposes only
- Scores are generated by AI and may not reflect real interview performance
- We reserve the right to remove inappropriate content

HR & Recruiter Terms:
- HR accounts must represent legitimate organizations
- Interview invites must be genuine job opportunities
- Harassment of candidates is strictly prohibited

Limitation of Liability:
- InterviewPro is a practice tool and not a job placement service
- We do not guarantee employment outcomes
- AI feedback is automated and may contain errors
...
A: Use Chrome browser and grant microphone permissions. Click the lock icon in your address bar to check.

Q: Why did my answer get a low score?
A: Our AI evaluates based on technical accuracy. Include specific terms and detailed explanations.

Q: Can HR see my personal information?
A: HR can only see your name, location, skills, and average score. Email is only shared when you get an invite.

Q: How do I delete my account?
A: Email us at support@interviewpro.click and we will delete your account within 24 hours.

Q: The interview is not saving my results?
A: Make sure you complete all questions and click Finish Interview. Partial sessions are not saved.

Q: Which browser should I use?
A: We strongly recommend Google Chrome for voice recognition.

Still need help?
Email: support@interviewpro.click`
    }
  }
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      document.querySelectorAll('button, a, [data-hover]').forEach(el => {
        el.addEventListener('mouseenter', () => gsap.to(cursor, { scale: 2.5, opacity: 0.4, duration: 0.3 }))
      ...
      gsap.to(noiseRef.current, {
        ...
        duration: 8, repeat: -1, ease: 'none', yoyo: true
      })
      ...
      const allChars = heroSplit.chars
      const interviewStart = 'Ace Your '.length

      allChars.forEach((char, i) => {
        if (i >= interviewStart) {
          char.style.background = 'linear-gradient(135deg, #a78bfa, #7c3aed, #ec4899)'
      ...
      gsap.fromTo(allChars,
        ...
        { y: 0, opacity: 1, rotateX: 0, duration: 0.6, stagger: 0.01, ease: 'back.out(1.7)', delay: 0.5 }
      )
      ...
      gsap.to(scrambleRef.current, {
        ...
        scrambleText: {
          ...
          chars: 'lowerCase', speed: 0.4, revealDelay: 0.3,
        }
      })
      ...
      gsap.to(badgeRef.current, {
        ...
        repeat: -1, yoyo: true, duration: 1.5, ease: 'power2.inOut', delay: 2
      })
      ...
      ;[card1Ref.current, card2Ref.current].forEach(card => {
        card.addEventListener('mousemove', (e) => {
          ...
          gsap.to(card, { rotateX: -y / 20, rotateY: x / 20, transformPerspective: 800, ease: 'power2.out', duration: 0.4 })
        })
      ...
      // ============ COUNTERS ============
      const targets = [
        { index: 0, end: 12, suffix: '' },
        { index: 1, end: 100, suffix: '%' },
        { index: 2, end: 65, suffix: '+' },
      ]
      targets.forEach(({ index, end, suffix }) => {
        ...
        ScrollTrigger.create({
          ...
          onEnter: () => {
            gsap.fromTo({ val: 0 }, { val: 0 }, {
              ...
              onUpdate: function () { ref.textContent = Math.round(this.targets()[0].val) + suffix }
            })
          },
          once: true
        })
      ...
      gsap.fromTo(statsRef.current.children,
        ...
        {
          y: 0, opacity: 1, scale: 1, duration: 0.7, stagger: 0.15, ease: 'back.out(1.7)',
      ...
      gsap.to(ctaRef.current?.querySelector('button'), {
        ...
        repeat: -1, yoyo: true, duration: 1.5, ease: 'power2.inOut', delay: 3
      })

      // ============ TICKER ============
      const ticker = document.querySelector('[data-ticker]')
      if (ticker) gsap.to(ticker, { xPercent: -50, duration: 20, repeat: -1, ease: 'none' })
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#080808] text-white flex flex-col overflow-x-hidden"
      ...
      <div ref={cursorDotRef}
        className="fixed w-1.5 h-1.5 rounded-full pointer-events-none z-[9999] bg-violet-400"
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div data-particle className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full blur-[130px] opacity-20"
          style={{ background: 'radial-gradient(circle, #7c3aed, transparent)' }} />
        <div data-particle className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full blur-[130px] opacity-15"
          style={{ background: 'radial-gradient(circle, #0d9488, transparent)' }} />
        <div data-particle className="absolute top-3/4 left-1/2 w-[300px] h-[300px] rounded-full blur-[100px] opacity-10"
      ...
      {/* Navbar */}
      <header ref={navRef} className="fixed top-0 w-full z-50" style={{ opacity: 0 }}>
      ...
      <section className="relative z-20 flex flex-col items-center justify-center text-center px-6 pt-40 pb-20 min-h-screen">
        <div ref={badgeRef}
          ...
          style={{ background: 'rgba(124,58,237,0.12)', border: '1px solid rgba(124,58,237,0.4)', color: '#a78bfa', opacity: 0 }}>
        ...
        <div className="flex flex-col sm:flex-row gap-5 w-full max-w-2xl mb-20"
          ...
          <div ref={card1Ref} data-hover
            ...
            style={{ background: 'rgba(20,20,20,0.8)', border: '1px solid rgba(124,58,237,0.25)', opacity: 0, transformStyle: 'preserve-3d' }}>
          ...
          <div ref={card2Ref} data-hover
            ...
            className="flex-1 cursor-pointer rounded-2xl p-7 text-left group relative overflow-hidden"
            style={{ background: 'rgba(20,20,20,0.8)', border: '1px solid rgba(13,148,136,0.25)', opacity: 0, transformStyle: 'preserve-3d' }}>
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"
      ...
      <div className="relative z-20 overflow-hidden py-6 border-y border-white/5"
        ...
        <div data-ticker className="flex gap-16 whitespace-nowrap" style={{ width: '200%' }}>
          {[...Array(2)].map((_, j) => (
      ...
      <section id="stats" className="relative z-20 py-24 px-8">
        <div ref={statsRef} className="max-w-4xl mx-auto grid grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="rounded-2xl p-8 text-center relative overflow-hidden group"
              style={{ background: 'rgba(15,15,15,0.8)', border: '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <p className="text-zinc-500 text-sm uppercase tracking-widest font-semibold relative z-10">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="relative z-20 max-w-7xl mx-auto px-8 py-24">
        <div className="text-center mb-16">
          <p className="text-xs uppercase tracking-widest font-bold mb-4" style={{ color: '#7c3aed' }}>Why InterviewPro</p>
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6"
                  ...
                  <span className="material-symbols-outlined text-2xl"
                    style={{ fontFamily: 'Material Symbols Outlined', color: f.color }}>{f.icon}</span>
                </div>
        ...
        <div ref={subjectsRef} className="flex flex-wrap gap-3 justify-center">
          {[
            ...
            <div key={i} data-pill data-hover
              ...
              style={{ background: 'rgba(15,15,15,0.8)', border: `1px solid ${s.color}30`, color: '#71717a' }}
              onMouseEnter={e => gsap.to(e.currentTarget, { color: '#fff', borderColor: s.color, duration: 0.2 })}
              onMouseLeave={e => gsap.to(e.currentTarget, { color: '#71717a', borderColor: `${s.color}30`, duration: 0.3 })}>
              <span>{s.icon}</span>
              {s.name}
            </div>
          ))}
      ...
      <section className="relative z-20 max-w-5xl mx-auto px-8 py-24 text-center">
        <div ref={ctaRef} className="rounded-3xl p-16 relative overflow-hidden"
          style={{ background: 'rgba(15,15,15,0.9)', border: '1px solid rgba(124,58,237,0.2)' }}>
      ...
      {/* Footer */}
      <footer className="w-full py-10 border-t border-white/5 relative z-20" style={{ background: '#050505' }}>
        <div className="flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-8 gap-4">
          ...
          <div className="flex gap-8">
            {['Privacy', 'Terms', 'Support'].map(item => (
              <button key={item} onClick={() => setModal(item)}
      ...
      {modal && (
        <div
          ...
          <div className="modal-box relative w-full max-w-lg rounded-2xl p-8 max-h-[80vh] overflow-y-auto"
            style={{ background: '#111', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 0 60px rgba(124,58,237,0.2)' }}
            onClick={e => e.stopPropagation()}>

            <button onClick={() => setModal(null)}
              className="absolute top-4 right-4 w-8 h-8 rounded-full flex items-center justify-center text-zinc-400 hover:text-white transition-colors"
              style={{ background: 'rgba(255,255,255,0.05)' }}>
              <span className="material-symbols-outlined text-sm"
                style={{ fontFamily: 'Material Symbols Outlined' }}>close</span>
            </button>
            ...
            <div className="mb-6">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4"
                ...
                <span className="material-symbols-outlined text-sm"
                  style={{ fontFamily: 'Material Symbols Outlined', color: '#a78bfa' }}>
                  {modalContent[modal].icon}
                </span>
              </div>
              <h2 className="text-2xl font-black text-white">{modalContent[modal].title}</h2>
            </div>
